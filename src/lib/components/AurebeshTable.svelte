...
<!-- TODO: add responsive sizing so that table remains in full view -->

<style>
  /* Aurebesh font styling (ensure your Aurebesh font is loaded) */
  .aurebesh {
    font-family: 'Aurebesh', sans-serif;
    font-size: 1.5rem;
    color: #00ff00;  /* Neon green for a futuristic feel */
  }
